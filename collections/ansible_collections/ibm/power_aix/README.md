...
IBM Power Systems AIX collection, as part of the broader offering of **Red Hat Ansible Certified Content for IBM Power Systems**, is available from Ansible Automation Hub with enterprise support.
